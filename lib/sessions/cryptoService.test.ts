...
describe('CryptoService', () => {
  ...
  describe('generateRandomCredentialsKey()', () => {
    ...
    it('should propagate errors from crypto.subtle.generateKey', async () => {
      ...
      await expect(
        cryptoService.generateRandomCredentialsKey()
      ).rejects.toThrow(
        'Credentials key generation failed: Key generation failed'
      );
    });
  });
  ...
  describe('encryptCredentials()', () => {
    ...
    it('should encrypt credentials successfully', async () => {
      const result = await cryptoService.encryptCredentials(
        credentialsKey,
        plaintext
      );
    ...
    it('should throw error when encryption fails', async () => {
      ...
      await expect(
        cryptoService.encryptCredentials(credentialsKey, plaintext)
      ).rejects.toThrow('Credential encryption failed: Encryption failed');
    });
  });
  ...
  describe('decryptCredentials()', () => {
    ...
    it('should decrypt credentials successfully', async () => {
      const result = await cryptoService.decryptCredentials(
        credentialsKey,
        ciphertextB64,
        ivB64
      );
    ...
    it('should call crypto.subtle.decrypt with correct parameters', async () => {
      await cryptoService.decryptCredentials(
        credentialsKey,
        ciphertextB64,
        ivB64
      );
    ...
    it('should throw error when decryption fails', async () => {
      ...
      await expect(
        cryptoService.decryptCredentials(credentialsKey, ciphertextB64, ivB64)
      ).rejects.toThrow('Credential decryption failed: Decryption failed');
    });
  });
  ...
  describe('wrapWithDeviceKey()', () => {
    ...
    it('should throw error when wrapping fails', async () => {
      ...
      ).rejects.toThrow('Device key wrapping failed: Wrapping failed');
    });
  });
  ...
  describe('unwrapWithDeviceKey()', () => {
    ...
    it('should throw error when unwrapping fails', async () => {
      ...
      ).rejects.toThrow('Device key unwrapping failed: Unwrapping failed');
    });
  });
  ...
  describe('wrapWithOriginKey()', () => {
    ...
    it('should wrap credentials key with origin key successfully', async () => {
      const result = await cryptoService.wrapWithOriginKey(
        credentialsKey,
        originKey
      );
    ...
    it('should throw error when wrapping fails', async () => {
      ...
      await expect(
        cryptoService.wrapWithOriginKey(credentialsKey, originKey)
      ).rejects.toThrow('Origin key wrapping failed: Wrapping failed');
    });
  });
  ...
  describe('unwrapWithOriginKey()', () => {
    ...
    it('should unwrap credentials key with origin key successfully', async () => {
      const result = await cryptoService.unwrapWithOriginKey(
        originKey,
        keyB64,
        ivB64
      );
    ...
    it('should throw error when unwrapping fails', async () => {
      ...
      await expect(
        cryptoService.unwrapWithOriginKey(originKey, keyB64, ivB64)
      ).rejects.toThrow('Origin key unwrapping failed: Unwrapping failed');
    });
  });
