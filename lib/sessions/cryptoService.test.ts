  ...
  describe('generateRandomCredentialsKey()', () => {
    ...
    it('should propagate errors from crypto.subtle.generateKey', async () => {
      ...
      await expect(
        ...
        '[CryptoService] Credentials key generation failed: Key generation failed'
      );
    });
  });
  ...
  describe('encryptCredentials()', () => {
    ...
    it('should throw error when encryption fails', async () => {
      ...
      await expect(
        ...
        '[CryptoService] Credential encryption failed: Encryption failed'
      );
    });
  });
  ...
  describe('decryptCredentials()', () => {
    ...
    it('should throw error when decryption fails', async () => {
      ...
      await expect(
        ...
        '[CryptoService] Credential decryption failed: Decryption failed'
      );
    });
  });
  ...
  describe('wrapWithOriginKey()', () => {
    ...
    it('should throw error when wrapping fails', async () => {
      ...
      await expect(
        ...
        '[CryptoService] Origin key wrapping failed: Wrapping failed'
      );
    });
  });
  ...
  describe('unwrapWithOriginKey()', () => {
    ...
    it('should throw error when unwrapping fails', async () => {
      ...
      await expect(
        ...
        '[CryptoService] Origin key unwrapping failed: Unwrapping failed'
      );
    });
  });
