...
describe('CredentialsEncrypter', () => {
    ...
    beforeEach(() => {
        ...
        mockCryptoService.generateRandomCredentialsKey.mockResolvedValue(mockCredentialsKey);
    ...
    describe('encrypt()', () => {
        ...
        it('should propagate errors from key generation', async () => {
            ...
            await expect(encrypter.encrypt(credentials)).rejects.toThrow('Key generation failed');
        });
        ...
        it('should propagate errors from encryption', async () => {
            ...
            await expect(encrypter.encrypt(credentials)).rejects.toThrow('Encryption failed');
        });
    });
    ...
    describe('decrypt()', () => {
        ...
        it('should propagate errors from decryption', async () => {
            ...
            await expect(encrypter.decrypt(encrypted)).rejects.toThrow('Decryption failed');
        });
    ...
    describe('Integration tests', () => {
        ...
        it('should work with different crypto service instances', async () => {
            const differentCryptoService = {
                generateRandomCredentialsKey: vi.fn().mockResolvedValue({} as CryptoKey),
            ...
            const differentEncrypter = new CredentialsEncrypter(differentCryptoService as any);
