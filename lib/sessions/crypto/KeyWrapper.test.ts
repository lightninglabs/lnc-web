...
describe('KeyWrapper', () => {
  ...
  describe('unwrapCredentialsKey()', () => {
    ...
    it('should verify keys match using encryption test', async () => {
      ...
      const key1 = { id: 'key1' } as unknown as CryptoKey;
      const key2 = { id: 'key2' } as unknown as CryptoKey;
    ...
    it('should throw error when keys do not match', async () => {
      ...
      await expect(
        keyWrapper.unwrapCredentialsKey(
          wrappedKeys,
          mockDeviceKey,
          mockOriginKey
        )
  ...
  describe('Integration tests', () => {
    ...
    it('should work with different wrapped key structures', async () => {
      ...
      mockCryptoService.unwrapWithDeviceKey.mockResolvedValue(
        mockCredentialsKey
      );
      mockCryptoService.unwrapWithOriginKey.mockResolvedValue(
        mockCredentialsKey
      );
