...
export class KeyWrapper {
  ...
  /**
   * Compare two CryptoKeys by encrypting the same test data with each and
   * checking that the resulting ciphertexts are identical.
   */
  ...
  /**
   * Constant‑time-ish comparison of two byte arrays for equality.
   */
