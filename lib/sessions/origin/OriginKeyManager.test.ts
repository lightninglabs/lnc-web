...
describe('OriginKeyManager', () => {
  ...
  describe('IndexedDB integration', () => {
    ...
    it('should return undefined when originKey is an array', async () => {
      fakeIndexedDB.store.set(namespace, {
        namespace,
        originKey: [],
    ...
    it('should close db and return undefined when transaction throws during load', async () => {
      ...
      vi.spyOn(originKeyManager as any, 'openDB').mockResolvedValue(fakeDb);
