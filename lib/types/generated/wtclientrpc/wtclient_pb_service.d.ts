...
export class WatchtowerClientClient {
  ...
  addTower(
    ...
    callback: (error: ServiceError|null, responseMessage: wtclientrpc_wtclient_pb.AddTowerResponse|null) => void
  ): UnaryResponse;
  addTower(
    requestMessage: wtclientrpc_wtclient_pb.AddTowerRequest,
    callback: (error: ServiceError|null, responseMessage: wtclientrpc_wtclient_pb.AddTowerResponse|null) => void
  ...
  removeTower(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: wtclientrpc_wtclient_pb.RemoveTowerResponse|null) => void
  ): UnaryResponse;
  removeTower(
    requestMessage: wtclientrpc_wtclient_pb.RemoveTowerRequest,
    callback: (error: ServiceError|null, responseMessage: wtclientrpc_wtclient_pb.RemoveTowerResponse|null) => void
  ...
  listTowers(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: wtclientrpc_wtclient_pb.ListTowersResponse|null) => void
  ): UnaryResponse;
  listTowers(
    requestMessage: wtclientrpc_wtclient_pb.ListTowersRequest,
    callback: (error: ServiceError|null, responseMessage: wtclientrpc_wtclient_pb.ListTowersResponse|null) => void
  ...
  getTowerInfo(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: wtclientrpc_wtclient_pb.Tower|null) => void
  ): UnaryResponse;
  getTowerInfo(
    requestMessage: wtclientrpc_wtclient_pb.GetTowerInfoRequest,
    callback: (error: ServiceError|null, responseMessage: wtclientrpc_wtclient_pb.Tower|null) => void
  ...
  stats(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: wtclientrpc_wtclient_pb.StatsResponse|null) => void
  ): UnaryResponse;
  stats(
    requestMessage: wtclientrpc_wtclient_pb.StatsRequest,
    callback: (error: ServiceError|null, responseMessage: wtclientrpc_wtclient_pb.StatsResponse|null) => void
  ...
  policy(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: wtclientrpc_wtclient_pb.PolicyResponse|null) => void
  ): UnaryResponse;
  policy(
    requestMessage: wtclientrpc_wtclient_pb.PolicyRequest,
    callback: (error: ServiceError|null, responseMessage: wtclientrpc_wtclient_pb.PolicyResponse|null) => void
