...
export class TraderClient {
    ...
    getInfo(
        ...
        callback: (
            ...
            responseMessage: trader_pb.GetInfoResponse | null
        ) => void
    ): UnaryResponse;
    getInfo(
        requestMessage: trader_pb.GetInfoRequest,
    ...
    stopDaemon(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.StopDaemonResponse | null
        ) => void
    ): UnaryResponse;
    stopDaemon(
        requestMessage: trader_pb.StopDaemonRequest,
    ...
    quoteAccount(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.QuoteAccountResponse | null
        ) => void
    ): UnaryResponse;
    quoteAccount(
        requestMessage: trader_pb.QuoteAccountRequest,
    ...
    initAccount(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.Account | null
        ) => void
    ): UnaryResponse;
    initAccount(
        requestMessage: trader_pb.InitAccountRequest,
    ...
    listAccounts(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.ListAccountsResponse | null
        ) => void
    ): UnaryResponse;
    listAccounts(
        requestMessage: trader_pb.ListAccountsRequest,
    ...
    closeAccount(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.CloseAccountResponse | null
        ) => void
    ): UnaryResponse;
    closeAccount(
        requestMessage: trader_pb.CloseAccountRequest,
    ...
    withdrawAccount(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.WithdrawAccountResponse | null
        ) => void
    ): UnaryResponse;
    withdrawAccount(
        requestMessage: trader_pb.WithdrawAccountRequest,
    ...
    depositAccount(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.DepositAccountResponse | null
        ) => void
    ): UnaryResponse;
    depositAccount(
        requestMessage: trader_pb.DepositAccountRequest,
    ...
    renewAccount(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.RenewAccountResponse | null
        ) => void
    ): UnaryResponse;
    renewAccount(
        requestMessage: trader_pb.RenewAccountRequest,
    ...
    bumpAccountFee(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.BumpAccountFeeResponse | null
        ) => void
    ): UnaryResponse;
    bumpAccountFee(
        requestMessage: trader_pb.BumpAccountFeeRequest,
    ...
    recoverAccounts(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.RecoverAccountsResponse | null
        ) => void
    ): UnaryResponse;
    recoverAccounts(
        requestMessage: trader_pb.RecoverAccountsRequest,
    ...
    submitOrder(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.SubmitOrderResponse | null
        ) => void
    ): UnaryResponse;
    submitOrder(
        requestMessage: trader_pb.SubmitOrderRequest,
    ...
    listOrders(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.ListOrdersResponse | null
        ) => void
    ): UnaryResponse;
    listOrders(
        requestMessage: trader_pb.ListOrdersRequest,
    ...
    cancelOrder(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.CancelOrderResponse | null
        ) => void
    ): UnaryResponse;
    cancelOrder(
        requestMessage: trader_pb.CancelOrderRequest,
    ...
    quoteOrder(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.QuoteOrderResponse | null
        ) => void
    ): UnaryResponse;
    quoteOrder(
        requestMessage: trader_pb.QuoteOrderRequest,
    ...
    auctionFee(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.AuctionFeeResponse | null
        ) => void
    ): UnaryResponse;
    auctionFee(
        requestMessage: trader_pb.AuctionFeeRequest,
    ...
    leaseDurations(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.LeaseDurationResponse | null
        ) => void
    ): UnaryResponse;
    leaseDurations(
        requestMessage: trader_pb.LeaseDurationRequest,
    ...
    nextBatchInfo(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.NextBatchInfoResponse | null
        ) => void
    ): UnaryResponse;
    nextBatchInfo(
        requestMessage: trader_pb.NextBatchInfoRequest,
    ...
    batchSnapshot(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: auctioneerrpc_auctioneer_pb.BatchSnapshotResponse | null
        ) => void
    ): UnaryResponse;
    batchSnapshot(
        requestMessage: auctioneerrpc_auctioneer_pb.BatchSnapshotRequest,
    ...
    getLsatTokens(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.TokensResponse | null
        ) => void
    ): UnaryResponse;
    getLsatTokens(
        requestMessage: trader_pb.TokensRequest,
    ...
    leases(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.LeasesResponse | null
        ) => void
    ): UnaryResponse;
    leases(
        requestMessage: trader_pb.LeasesRequest,
    ...
    nodeRatings(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.NodeRatingResponse | null
        ) => void
    ): UnaryResponse;
    nodeRatings(
        requestMessage: trader_pb.NodeRatingRequest,
    ...
    batchSnapshots(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: auctioneerrpc_auctioneer_pb.BatchSnapshotsResponse | null
        ) => void
    ): UnaryResponse;
    batchSnapshots(
        requestMessage: auctioneerrpc_auctioneer_pb.BatchSnapshotsRequest,
    ...
    offerSidecar(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.SidecarTicket | null
        ) => void
    ): UnaryResponse;
    offerSidecar(
        requestMessage: trader_pb.OfferSidecarRequest,
    ...
    expectSidecarChannel(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.ExpectSidecarChannelResponse | null
        ) => void
    ): UnaryResponse;
    expectSidecarChannel(
        requestMessage: trader_pb.ExpectSidecarChannelRequest,
    ...
    decodeSidecarTicket(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.DecodedSidecarTicket | null
        ) => void
    ): UnaryResponse;
    decodeSidecarTicket(
        requestMessage: trader_pb.SidecarTicket,
    ...
    listSidecars(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.ListSidecarsResponse | null
        ) => void
    ): UnaryResponse;
    listSidecars(
        requestMessage: trader_pb.ListSidecarsRequest,
    ...
    cancelSidecar(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: trader_pb.CancelSidecarResponse | null
        ) => void
    ): UnaryResponse;
    cancelSidecar(
        requestMessage: trader_pb.CancelSidecarRequest,
