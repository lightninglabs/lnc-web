...
export class InvoicesClient {
    ...
    subscribeSingleInvoice(
        requestMessage: invoicesrpc_invoices_pb.SubscribeSingleInvoiceRequest,
        metadata?: grpc.Metadata
    ...
    cancelInvoice(
        ...
        callback: (
            ...
            responseMessage: invoicesrpc_invoices_pb.CancelInvoiceResp | null
        ) => void
    ): UnaryResponse;
    cancelInvoice(
        requestMessage: invoicesrpc_invoices_pb.CancelInvoiceMsg,
    ...
    addHoldInvoice(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: invoicesrpc_invoices_pb.AddHoldInvoiceResp | null
        ) => void
    ): UnaryResponse;
    addHoldInvoice(
        requestMessage: invoicesrpc_invoices_pb.AddHoldInvoiceRequest,
    ...
    settleInvoice(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: invoicesrpc_invoices_pb.SettleInvoiceResp | null
        ) => void
    ): UnaryResponse;
    settleInvoice(
        requestMessage: invoicesrpc_invoices_pb.SettleInvoiceMsg,
