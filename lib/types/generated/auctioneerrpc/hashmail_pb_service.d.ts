...
export class HashMailClient {
  ...
  newCipherBox(
    ...
    callback: (error: ServiceError|null, responseMessage: auctioneerrpc_hashmail_pb.CipherInitResp|null) => void
  ): UnaryResponse;
  newCipherBox(
    requestMessage: auctioneerrpc_hashmail_pb.CipherBoxAuth,
    callback: (error: ServiceError|null, responseMessage: auctioneerrpc_hashmail_pb.CipherInitResp|null) => void
  ...
  delCipherBox(
    requestMessage: auctioneerrpc_hashmail_pb.CipherBoxAuth,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: auctioneerrpc_hashmail_pb.DelCipherBoxResp|null) => void
  ): UnaryResponse;
  delCipherBox(
    requestMessage: auctioneerrpc_hashmail_pb.CipherBoxAuth,
    callback: (error: ServiceError|null, responseMessage: auctioneerrpc_hashmail_pb.DelCipherBoxResp|null) => void
  ): UnaryResponse;
  sendStream(metadata?: grpc.Metadata): RequestStream<auctioneerrpc_hashmail_pb.CipherBox>;
  recvStream(requestMessage: auctioneerrpc_hashmail_pb.CipherBoxDesc, metadata?: grpc.Metadata): ResponseStream<auctioneerrpc_hashmail_pb.CipherBox>;
}
