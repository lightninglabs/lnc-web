...
export class ChannelAuctioneerClient {
    ...
    reserveAccount(
        ...
        callback: (
            ...
            responseMessage: auctioneerrpc_auctioneer_pb.ReserveAccountResponse | null
        ) => void
    ): UnaryResponse;
    reserveAccount(
        requestMessage: auctioneerrpc_auctioneer_pb.ReserveAccountRequest,
    ...
    initAccount(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: auctioneerrpc_auctioneer_pb.ServerInitAccountResponse | null
        ) => void
    ): UnaryResponse;
    initAccount(
        requestMessage: auctioneerrpc_auctioneer_pb.ServerInitAccountRequest,
    ...
    modifyAccount(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: auctioneerrpc_auctioneer_pb.ServerModifyAccountResponse | null
        ) => void
    ): UnaryResponse;
    modifyAccount(
        requestMessage: auctioneerrpc_auctioneer_pb.ServerModifyAccountRequest,
    ...
    submitOrder(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: auctioneerrpc_auctioneer_pb.ServerSubmitOrderResponse | null
        ) => void
    ): UnaryResponse;
    submitOrder(
        requestMessage: auctioneerrpc_auctioneer_pb.ServerSubmitOrderRequest,
    ...
    cancelOrder(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: auctioneerrpc_auctioneer_pb.ServerCancelOrderResponse | null
        ) => void
    ): UnaryResponse;
    cancelOrder(
        requestMessage: auctioneerrpc_auctioneer_pb.ServerCancelOrderRequest,
    ...
    orderState(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: auctioneerrpc_auctioneer_pb.ServerOrderStateResponse | null
        ) => void
    ): UnaryResponse;
    orderState(
        requestMessage: auctioneerrpc_auctioneer_pb.ServerOrderStateRequest,
    ...
    subscribeBatchAuction(
        ...
        auctioneerrpc_auctioneer_pb.ClientAuctionMessage,
        auctioneerrpc_auctioneer_pb.ServerAuctionMessage
    >;
    subscribeSidecar(
        metadata?: grpc.Metadata
    ): BidirectionalStream<
    ...
    terms(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: auctioneerrpc_auctioneer_pb.TermsResponse | null
        ) => void
    ): UnaryResponse;
    terms(
        requestMessage: auctioneerrpc_auctioneer_pb.TermsRequest,
    ...
    relevantBatchSnapshot(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: auctioneerrpc_auctioneer_pb.RelevantBatch | null
        ) => void
    ): UnaryResponse;
    relevantBatchSnapshot(
        requestMessage: auctioneerrpc_auctioneer_pb.RelevantBatchRequest,
    ...
    nodeRating(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: auctioneerrpc_auctioneer_pb.ServerNodeRatingResponse | null
        ) => void
    ): UnaryResponse;
    nodeRating(
        requestMessage: auctioneerrpc_auctioneer_pb.ServerNodeRatingRequest,
    ...
    marketInfo(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: auctioneerrpc_auctioneer_pb.MarketInfoResponse | null
        ) => void
    ): UnaryResponse;
    marketInfo(
        requestMessage: auctioneerrpc_auctioneer_pb.MarketInfoRequest,
