...
export class WalletKitClient {
    ...
    listUnspent(
        ...
        callback: (
            ...
            responseMessage: walletrpc_walletkit_pb.ListUnspentResponse | null
        ) => void
    ): UnaryResponse;
    listUnspent(
        requestMessage: walletrpc_walletkit_pb.ListUnspentRequest,
    ...
    leaseOutput(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.LeaseOutputResponse | null
        ) => void
    ): UnaryResponse;
    leaseOutput(
        requestMessage: walletrpc_walletkit_pb.LeaseOutputRequest,
    ...
    releaseOutput(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.ReleaseOutputResponse | null
        ) => void
    ): UnaryResponse;
    releaseOutput(
        requestMessage: walletrpc_walletkit_pb.ReleaseOutputRequest,
    ...
    listLeases(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.ListLeasesResponse | null
        ) => void
    ): UnaryResponse;
    listLeases(
        requestMessage: walletrpc_walletkit_pb.ListLeasesRequest,
    ...
    deriveNextKey(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: signrpc_signer_pb.KeyDescriptor | null
        ) => void
    ): UnaryResponse;
    deriveNextKey(
        requestMessage: walletrpc_walletkit_pb.KeyReq,
    ...
    nextAddr(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.AddrResponse | null
        ) => void
    ): UnaryResponse;
    nextAddr(
        requestMessage: walletrpc_walletkit_pb.AddrRequest,
    ...
    listAccounts(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.ListAccountsResponse | null
        ) => void
    ): UnaryResponse;
    listAccounts(
        requestMessage: walletrpc_walletkit_pb.ListAccountsRequest,
    ...
    importAccount(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.ImportAccountResponse | null
        ) => void
    ): UnaryResponse;
    importAccount(
        requestMessage: walletrpc_walletkit_pb.ImportAccountRequest,
    ...
    importPublicKey(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.ImportPublicKeyResponse | null
        ) => void
    ): UnaryResponse;
    importPublicKey(
        requestMessage: walletrpc_walletkit_pb.ImportPublicKeyRequest,
    ...
    publishTransaction(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.PublishResponse | null
        ) => void
    ): UnaryResponse;
    publishTransaction(
        requestMessage: walletrpc_walletkit_pb.Transaction,
    ...
    sendOutputs(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.SendOutputsResponse | null
        ) => void
    ): UnaryResponse;
    sendOutputs(
        requestMessage: walletrpc_walletkit_pb.SendOutputsRequest,
    ...
    estimateFee(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.EstimateFeeResponse | null
        ) => void
    ): UnaryResponse;
    estimateFee(
        requestMessage: walletrpc_walletkit_pb.EstimateFeeRequest,
    ...
    pendingSweeps(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.PendingSweepsResponse | null
        ) => void
    ): UnaryResponse;
    pendingSweeps(
        requestMessage: walletrpc_walletkit_pb.PendingSweepsRequest,
    ...
    bumpFee(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.BumpFeeResponse | null
        ) => void
    ): UnaryResponse;
    bumpFee(
        requestMessage: walletrpc_walletkit_pb.BumpFeeRequest,
    ...
    listSweeps(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.ListSweepsResponse | null
        ) => void
    ): UnaryResponse;
    listSweeps(
        requestMessage: walletrpc_walletkit_pb.ListSweepsRequest,
    ...
    labelTransaction(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.LabelTransactionResponse | null
        ) => void
    ): UnaryResponse;
    labelTransaction(
        requestMessage: walletrpc_walletkit_pb.LabelTransactionRequest,
    ...
    fundPsbt(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.FundPsbtResponse | null
        ) => void
    ): UnaryResponse;
    fundPsbt(
        requestMessage: walletrpc_walletkit_pb.FundPsbtRequest,
    ...
    signPsbt(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.SignPsbtResponse | null
        ) => void
    ): UnaryResponse;
    signPsbt(
        requestMessage: walletrpc_walletkit_pb.SignPsbtRequest,
    ...
    finalizePsbt(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: walletrpc_walletkit_pb.FinalizePsbtResponse | null
        ) => void
    ): UnaryResponse;
    finalizePsbt(
        requestMessage: walletrpc_walletkit_pb.FinalizePsbtRequest,
