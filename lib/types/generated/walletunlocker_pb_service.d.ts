...
export class WalletUnlockerClient {
  ...
  genSeed(
    ...
    callback: (error: ServiceError|null, responseMessage: walletunlocker_pb.GenSeedResponse|null) => void
  ): UnaryResponse;
  genSeed(
    requestMessage: walletunlocker_pb.GenSeedRequest,
    callback: (error: ServiceError|null, responseMessage: walletunlocker_pb.GenSeedResponse|null) => void
  ...
  initWallet(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: walletunlocker_pb.InitWalletResponse|null) => void
  ): UnaryResponse;
  initWallet(
    requestMessage: walletunlocker_pb.InitWalletRequest,
    callback: (error: ServiceError|null, responseMessage: walletunlocker_pb.InitWalletResponse|null) => void
  ...
  unlockWallet(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: walletunlocker_pb.UnlockWalletResponse|null) => void
  ): UnaryResponse;
  unlockWallet(
    requestMessage: walletunlocker_pb.UnlockWalletRequest,
    callback: (error: ServiceError|null, responseMessage: walletunlocker_pb.UnlockWalletResponse|null) => void
  ...
  changePassword(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: walletunlocker_pb.ChangePasswordResponse|null) => void
  ): UnaryResponse;
  changePassword(
    requestMessage: walletunlocker_pb.ChangePasswordRequest,
    callback: (error: ServiceError|null, responseMessage: walletunlocker_pb.ChangePasswordResponse|null) => void
