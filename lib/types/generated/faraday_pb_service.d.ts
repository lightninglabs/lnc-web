...
export class FaradayServerClient {
  ...
  outlierRecommendations(
    ...
    callback: (error: ServiceError|null, responseMessage: faraday_pb.CloseRecommendationsResponse|null) => void
  ): UnaryResponse;
  outlierRecommendations(
    requestMessage: faraday_pb.OutlierRecommendationsRequest,
    callback: (error: ServiceError|null, responseMessage: faraday_pb.CloseRecommendationsResponse|null) => void
  ...
  revenueReport(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: faraday_pb.RevenueReportResponse|null) => void
  ): UnaryResponse;
  revenueReport(
    requestMessage: faraday_pb.RevenueReportRequest,
    callback: (error: ServiceError|null, responseMessage: faraday_pb.RevenueReportResponse|null) => void
  ...
  channelInsights(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: faraday_pb.ChannelInsightsResponse|null) => void
  ): UnaryResponse;
  channelInsights(
    requestMessage: faraday_pb.ChannelInsightsRequest,
    callback: (error: ServiceError|null, responseMessage: faraday_pb.ChannelInsightsResponse|null) => void
  ...
  exchangeRate(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: faraday_pb.ExchangeRateResponse|null) => void
  ): UnaryResponse;
  exchangeRate(
    requestMessage: faraday_pb.ExchangeRateRequest,
    callback: (error: ServiceError|null, responseMessage: faraday_pb.ExchangeRateResponse|null) => void
  ...
  nodeAudit(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: faraday_pb.NodeAuditResponse|null) => void
  ): UnaryResponse;
  nodeAudit(
    requestMessage: faraday_pb.NodeAuditRequest,
    callback: (error: ServiceError|null, responseMessage: faraday_pb.NodeAuditResponse|null) => void
  ...
  closeReport(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: faraday_pb.CloseReportResponse|null) => void
  ): UnaryResponse;
  closeReport(
    requestMessage: faraday_pb.CloseReportRequest,
    callback: (error: ServiceError|null, responseMessage: faraday_pb.CloseReportResponse|null) => void
