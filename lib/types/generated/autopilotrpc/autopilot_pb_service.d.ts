...
export class AutopilotClient {
  ...
  status(
    ...
    callback: (error: ServiceError|null, responseMessage: autopilotrpc_autopilot_pb.StatusResponse|null) => void
  ): UnaryResponse;
  status(
    requestMessage: autopilotrpc_autopilot_pb.StatusRequest,
    callback: (error: ServiceError|null, responseMessage: autopilotrpc_autopilot_pb.StatusResponse|null) => void
  ...
  modifyStatus(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: autopilotrpc_autopilot_pb.ModifyStatusResponse|null) => void
  ): UnaryResponse;
  modifyStatus(
    requestMessage: autopilotrpc_autopilot_pb.ModifyStatusRequest,
    callback: (error: ServiceError|null, responseMessage: autopilotrpc_autopilot_pb.ModifyStatusResponse|null) => void
  ...
  queryScores(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: autopilotrpc_autopilot_pb.QueryScoresResponse|null) => void
  ): UnaryResponse;
  queryScores(
    requestMessage: autopilotrpc_autopilot_pb.QueryScoresRequest,
    callback: (error: ServiceError|null, responseMessage: autopilotrpc_autopilot_pb.QueryScoresResponse|null) => void
  ...
  setScores(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: autopilotrpc_autopilot_pb.SetScoresResponse|null) => void
  ): UnaryResponse;
  setScores(
    requestMessage: autopilotrpc_autopilot_pb.SetScoresRequest,
    callback: (error: ServiceError|null, responseMessage: autopilotrpc_autopilot_pb.SetScoresResponse|null) => void
