...
export class SignerClient {
    ...
    signOutputRaw(
        ...
        callback: (
            ...
            responseMessage: signrpc_signer_pb.SignResp | null
        ) => void
    ): UnaryResponse;
    signOutputRaw(
        requestMessage: signrpc_signer_pb.SignReq,
    ...
    computeInputScript(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: signrpc_signer_pb.InputScriptResp | null
        ) => void
    ): UnaryResponse;
    computeInputScript(
        requestMessage: signrpc_signer_pb.SignReq,
    ...
    signMessage(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: signrpc_signer_pb.SignMessageResp | null
        ) => void
    ): UnaryResponse;
    signMessage(
        requestMessage: signrpc_signer_pb.SignMessageReq,
    ...
    verifyMessage(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: signrpc_signer_pb.VerifyMessageResp | null
        ) => void
    ): UnaryResponse;
    verifyMessage(
        requestMessage: signrpc_signer_pb.VerifyMessageReq,
    ...
    deriveSharedKey(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: signrpc_signer_pb.SharedKeyResponse | null
        ) => void
    ): UnaryResponse;
    deriveSharedKey(
        requestMessage: signrpc_signer_pb.SharedKeyRequest,
