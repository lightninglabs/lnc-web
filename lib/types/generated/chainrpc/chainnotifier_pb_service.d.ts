...
export class ChainNotifierClient {
  ...
  registerConfirmationsNtfn(requestMessage: chainrpc_chainnotifier_pb.ConfRequest, metadata?: grpc.Metadata): ResponseStream<chainrpc_chainnotifier_pb.ConfEvent>;
  registerSpendNtfn(requestMessage: chainrpc_chainnotifier_pb.SpendRequest, metadata?: grpc.Metadata): ResponseStream<chainrpc_chainnotifier_pb.SpendEvent>;
  registerBlockEpochNtfn(requestMessage: chainrpc_chainnotifier_pb.BlockEpoch, metadata?: grpc.Metadata): ResponseStream<chainrpc_chainnotifier_pb.BlockEpoch>;
}
