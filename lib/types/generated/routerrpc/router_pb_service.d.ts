...
export class RouterClient {
    ...
    sendPaymentV2(
        requestMessage: routerrpc_router_pb.SendPaymentRequest,
        metadata?: grpc.Metadata
    ): ResponseStream<lightning_pb.Payment>;
    trackPaymentV2(
        requestMessage: routerrpc_router_pb.TrackPaymentRequest,
        metadata?: grpc.Metadata
    ): ResponseStream<lightning_pb.Payment>;
    estimateRouteFee(
        ...
        callback: (
            ...
            responseMessage: routerrpc_router_pb.RouteFeeResponse | null
        ) => void
    ): UnaryResponse;
    estimateRouteFee(
        requestMessage: routerrpc_router_pb.RouteFeeRequest,
    ...
    sendToRoute(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: routerrpc_router_pb.SendToRouteResponse | null
        ) => void
    ): UnaryResponse;
    sendToRoute(
        requestMessage: routerrpc_router_pb.SendToRouteRequest,
    ...
    sendToRouteV2(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: lightning_pb.HTLCAttempt | null
        ) => void
    ): UnaryResponse;
    sendToRouteV2(
        requestMessage: routerrpc_router_pb.SendToRouteRequest,
    ...
    resetMissionControl(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: routerrpc_router_pb.ResetMissionControlResponse | null
        ) => void
    ): UnaryResponse;
    resetMissionControl(
        requestMessage: routerrpc_router_pb.ResetMissionControlRequest,
    ...
    queryMissionControl(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: routerrpc_router_pb.QueryMissionControlResponse | null
        ) => void
    ): UnaryResponse;
    queryMissionControl(
        requestMessage: routerrpc_router_pb.QueryMissionControlRequest,
    ...
    xImportMissionControl(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: routerrpc_router_pb.XImportMissionControlResponse | null
        ) => void
    ): UnaryResponse;
    xImportMissionControl(
        requestMessage: routerrpc_router_pb.XImportMissionControlRequest,
    ...
    getMissionControlConfig(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: routerrpc_router_pb.GetMissionControlConfigResponse | null
        ) => void
    ): UnaryResponse;
    getMissionControlConfig(
        requestMessage: routerrpc_router_pb.GetMissionControlConfigRequest,
    ...
    setMissionControlConfig(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: routerrpc_router_pb.SetMissionControlConfigResponse | null
        ) => void
    ): UnaryResponse;
    setMissionControlConfig(
        requestMessage: routerrpc_router_pb.SetMissionControlConfigRequest,
    ...
    queryProbability(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: routerrpc_router_pb.QueryProbabilityResponse | null
        ) => void
    ): UnaryResponse;
    queryProbability(
        requestMessage: routerrpc_router_pb.QueryProbabilityRequest,
    ...
    buildRoute(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: routerrpc_router_pb.BuildRouteResponse | null
        ) => void
    ): UnaryResponse;
    buildRoute(
        requestMessage: routerrpc_router_pb.BuildRouteRequest,
    ...
    subscribeHtlcEvents(
        requestMessage: routerrpc_router_pb.SubscribeHtlcEventsRequest,
        metadata?: grpc.Metadata
    ): ResponseStream<routerrpc_router_pb.HtlcEvent>;
    sendPayment(
        requestMessage: routerrpc_router_pb.SendPaymentRequest,
        metadata?: grpc.Metadata
    ): ResponseStream<routerrpc_router_pb.PaymentStatus>;
    trackPayment(
        requestMessage: routerrpc_router_pb.TrackPaymentRequest,
        metadata?: grpc.Metadata
    ): ResponseStream<routerrpc_router_pb.PaymentStatus>;
    htlcInterceptor(
        ...
        routerrpc_router_pb.ForwardHtlcInterceptResponse,
        routerrpc_router_pb.ForwardHtlcInterceptRequest
    >;
    updateChanStatus(
        ...
        callback: (
            error: ServiceError | null,
            responseMessage: routerrpc_router_pb.UpdateChanStatusResponse | null
        ) => void
    ): UnaryResponse;
    updateChanStatus(
        requestMessage: routerrpc_router_pb.UpdateChanStatusRequest,
