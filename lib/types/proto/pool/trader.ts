...
export interface Trader {
     ...
     */
    withdrawAccount(
        request?: DeepPartial<WithdrawAccountRequest>
     ...
     */
    depositAccount(
        request?: DeepPartial<DepositAccountRequest>
     ...
     */
    bumpAccountFee(
        request?: DeepPartial<BumpAccountFeeRequest>
    ): Promise<BumpAccountFeeResponse>;
    /**
     ...
     */
    leaseDurations(
        request?: DeepPartial<LeaseDurationRequest>
    ): Promise<LeaseDurationResponse>;
    /**
     ...
     */
    nextBatchInfo(
        request?: DeepPartial<NextBatchInfoRequest>
    ): Promise<NextBatchInfoResponse>;
    /**
    ...
    expectSidecarChannel(
        request?: DeepPartial<ExpectSidecarChannelRequest>
    ): Promise<ExpectSidecarChannelResponse>;
    /**
     ...
     */
    cancelSidecar(
        request?: DeepPartial<CancelSidecarRequest>
    ): Promise<CancelSidecarResponse>;
}
