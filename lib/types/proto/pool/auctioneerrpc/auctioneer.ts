...
export interface ChannelAuctioneer {
    reserveAccount(
        request?: DeepPartial<ReserveAccountRequest>
    ): Promise<ReserveAccountResponse>;
    initAccount(
        request?: DeepPartial<ServerInitAccountRequest>
    ): Promise<ServerInitAccountResponse>;
    modifyAccount(
        request?: DeepPartial<ServerModifyAccountRequest>
    ): Promise<ServerModifyAccountResponse>;
    submitOrder(
        request?: DeepPartial<ServerSubmitOrderRequest>
    ): Promise<ServerSubmitOrderResponse>;
    cancelOrder(
        request?: DeepPartial<ServerCancelOrderRequest>
    ): Promise<ServerCancelOrderResponse>;
    orderState(
    ...
    ): Promise<RelevantBatch>;
    batchSnapshot(
        request?: DeepPartial<BatchSnapshotRequest>
    ): Promise<BatchSnapshotResponse>;
    nodeRating(
        request?: DeepPartial<ServerNodeRatingRequest>
    ): Promise<ServerNodeRatingResponse>;
    batchSnapshots(
