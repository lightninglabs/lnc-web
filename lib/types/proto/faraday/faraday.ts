...
export enum CloseRecommendationRequest_Metric {
    UNKNOWN = 'UNKNOWN',
    UPTIME = 'UPTIME',
    REVENUE = 'REVENUE',
...
export interface RevenueReport {
     ...
     */
    pairReports: { [key: string]: PairReport };
}
...
export interface FaradayServer {
    ...
    outlierRecommendations(
        request?: DeepPartial<OutlierRecommendationsRequest>
    ): Promise<CloseRecommendationsResponse>;
    /**
     * frcli: `threshold`
    ...
    thresholdRecommendations(
        request?: DeepPartial<ThresholdRecommendationsRequest>
    ): Promise<CloseRecommendationsResponse>;
    /**
     * frcli: `revenue`
     ...
     */
    revenueReport(
        request?: DeepPartial<RevenueReportRequest>
     ...
     */
    channelInsights(
        request?: DeepPartial<ChannelInsightsRequest>
