...
describe('PasskeyEncryptionService', () => {
  ...
  beforeEach(() => {
    ...
    originalGlobalPublicKeyCredential = (globalThis as any).PublicKeyCredential;
    (globalThis as any).PublicKeyCredential = mockPublicKeyCredential as any;
  ...
  describe('isSupported() static method', () => {
    ...
    it('should return true when extension results API is unavailable', async () => {
      ...
      expect(result).toBe(true);
      mockPublicKeyCredential.getClientExtensionResults = originalExtensionFn;
    });
  ...
  describe('Private methods', () => {
    describe('createNewPasskey()', () => {
      ...
      it('should throw error when credential creation fails', async () => {
        ...
        await expect((service as any).createNewPasskey()).rejects.toThrow(
    ...
    describe('authenticateWithExistingPasskey()', () => {
      ...
      it('should throw error when authentication fails', async () => {
        ...
        await expect(
          (service as any).authenticateWithExistingPasskey(testCredentialId)
    ...
    describe('deriveEncryptionKey()', () => {
      it('should derive encryption key from PRF output', async () => {
        ...
        await (service as any).deriveEncryptionKey(mockCredential, challenge);
      ...
      it('should throw error when PRF extension is not supported', async () => {
        ...
        await expect(
          (service as any).deriveEncryptionKey(mockCredential, challenge)
        ).rejects.toThrow('PRF extension not supported or failed');
      });

      it('should throw error when extension API is missing', async () => {
        const originalExtensionFn = mockCredential.getClientExtensionResults;
    ...
    describe('generateDeterministicChallenge()', () => {
      it('should generate deterministic challenge based on namespace', () => {
        const challenge1 = (service as any).generateDeterministicChallenge();
        const challenge2 = (service as any).generateDeterministicChallenge();
      ...
      it('should generate different challenges for different namespaces', () => {
        ...
        const challenge1 = (service1 as any).generateDeterministicChallenge();
        const challenge2 = (service2 as any).generateDeterministicChallenge();
