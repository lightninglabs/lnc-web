...
describe('PasskeyEncryptionService', () => {
  ...
  describe('Private methods', () => {
    ...
    describe('generateDeterministicChallenge()', () => {
      it('should generate deterministic challenge based on namespace', async () => {
        const challenge1 = await (
          service as any
        ).generateDeterministicChallenge();
        const challenge2 = await (
          service as any
        ).generateDeterministicChallenge();
      ...
      it('should generate different challenges for different namespaces', async () => {
