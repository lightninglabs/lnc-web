...
export const lndGetInfo: LND.GetInfoResponse.AsObject = {
    ...
    identityPubkey:
        '038b3fc29cfc195c9b190d86ad2d40ce7550a5c6f13941f53c7d7ac5b25c912a6c',
    alias: 'alice',
    color: '#cccccc',
    ...
    blockHeight: 185,
    blockHash:
        '547d3dcfb7d56532bed2efdeea0d400f11167b34d493bcd45fedb21f2ef7ed43',
...
export const lndGetNodeInfo: Required<LND.NodeInfo.AsObject> = {
    ...
    node: {
        ...
        features: [
            ...
            [
                13,
                { name: 'static-remote-key', isRequired: false, isKnown: true }
            ],
            [15, { name: 'payment-addr', isRequired: false, isKnown: true }],
            [
                17,
...
export const lndListChannelsMany: LND.ListChannelsResponse.AsObject = {
    channels: [...Array(500)].map((_, i) => {
        ...
        const local = Math.max(
            100000,
            Math.floor(Math.random() * cap - 100000)
        );
        return {
            ...c,
            chanId: `${i || ''}${c.chanId}`,
            channelPoint: `${c.channelPoint.substring(
                0,
                c.channelPoint.length - 2
            )}:${i}`,
            ...
            capacity: cap,
            uptime:
                Math.floor(Math.random() * (+c.lifetime / 2)) + +c.lifetime / 2
        };
    })
};

export const lndListChannels: LND.ListChannelsResponse.AsObject = {
    channels: lndListChannelsMany.channels.slice(0, 10)
};
...
export const lndPendingChannel: LND.PendingChannelsResponse.PendingChannel.AsObject =
    {
        capacity: 500000,
        channelPoint:
            '987da7ae4e56a30ee841edc5a4ccf61112e98bce7d4acfdf8e71a670296d16a7:0',
        commitmentType: 1,
        initiator: 2,
        localBalance: 0,
        ...
        remoteNodePub:
            '03bb934930cdcd25576aa61d08cc95214e0036f1219c435c06976e561558703290',
        numForwardingPackages: 10,
        chanStatusFlags: 'Test'
    };
    ...
    pendingOpenChannels: [
        {
            channel: {
                ...lndPendingChannel,
                channelPoint: lndListChannels.channels[0].channelPoint
            },
            commitFee: 9050,
            commitWeight: 552,
    ...
    pendingClosingChannels: [
        {
            channel: {
                ...lndPendingChannel,
                channelPoint: lndListChannels.channels[1].channelPoint
            },
            closingTxid:
                'fe65f668a1efe1c088b0e7d44abb707cb0171ebbbe43e8f6bb985a98643f1672'
        }
    ],
    waitingCloseChannels: [
        {
            channel: {
                ...lndPendingChannel,
                channelPoint: lndListChannels.channels[2].channelPoint
            },
            commitments: {
                ...
                remotePendingTxid: '',
                remoteTxid:
                    '9850a4b1cfcfbf972f8541b26b8061ed3091ee8cbed5875167080be4be9524e7'
            },
            limboBalance: 0,
            closingTxid:
                '9850a4b1cfcfbf972f8541b26b8061ed3091ee8cbed5875167080be4be9524e7'
    ...
    pendingForceClosingChannels: [
        {
            channel: {
                ...lndPendingChannel,
                channelPoint: lndListChannels.channels[3].channelPoint
            },
            anchor: 0,
            blocksTilMaturity: 142,
            closingTxid:
                '6c151252215b73547a5415051c82dd25c725c4309b93fed4f38c4c5b610c3fb0',
            limboBalance: 990950,
            maturityHeight: 440,
            pendingHtlcs: [],
            recoveredBalance: 0
...
export const lndChannelEvent: Required<LND.ChannelEventUpdate.AsObject> = {
    ...
    closedChannel: {
        ...
        closeType: 0,
        closingTxHash:
            '1f765f45f2a6d33837a203e3fc911915c891e9b86f9c9d91a1931b92efdedf5b',
        remotePubkey:
            '030e98fdacf2464bdfb027b866a018d6cdc5108514208988873abea7eff59afd91',
...
export const lndGetChanInfo: Required<LND.ChannelEdge.AsObject> = {
    ...
    node2Pub:
        '021626ad63f6876f2baa6000739312690b027ec289b9d1bf9184f3194e8c923dad',
    capacity: 1800000,
    node1Policy: {
        timeLockDelta: 3000,
        minHtlc: 1000,
...
export const loopListSwaps: LOOP.ListSwapsResponse.AsObject = {
    swaps: [...Array(7)].map((x, i) => ({
        amt: Number(`${500000 + i * 5000}`),
        ...
        failureReason: (i % 2 === 0
            ? 0
            : i % 7) as LOOP.SwapStatus.AsObject['failureReason'],
        initiationTime: Number(`${1586390353623905000 + i * 100000000000000}`),
        lastUpdateTime: Number(`${1586398369729857000 + i * 200000000000000}`),
        htlcAddress:
            'bcrt1qzu4077erkr78k52yuf2rwkk6ayr6m3wtazdfz2qqmd7taa5vvy9s5d75gd',
        htlcAddressP2wsh:
            'bcrt1qzu4077erkr78k52yuf2rwkk6ayr6m3wtazdfz2qqmd7taa5vvy9s5d75gd',
        htlcAddressNp2wsh: '',
        costServer: 66,
...
export const loopSwapResponse: LOOP.SwapResponse.AsObject = {
    htlcAddress:
        'bcrt1qkjct8aqxfwyla50mfxdnzlmuphg3zwuz2zmuy99c9sw67xj7tn2sfkflhw',
    htlcAddressNp2wsh: '',
    htlcAddressP2wsh:
        'bcrt1qkjct8aqxfwyla50mfxdnzlmuphg3zwuz2zmuy99c9sw67xj7tn2sfkflhw',
...
export const poolWithdrawAccount: Required<POOL.WithdrawAccountResponse.AsObject> =
    {
        ...
        account: {
            ...poolInitAccount,
            state: POOL.AccountState.PENDING_UPDATE,
            value: Number(`${+poolInitAccount.value - 1}`)
        }
    };
...
export const poolBatchSnapshot: AUCT.BatchSnapshotResponse.AsObject = {
    ...
    batchTxId:
        '6f29af3cb54480fec52d3a48ba94a5327aa31ed2c3b85ee8f0fd0da2f5ea8620',
    batchTx:
...
export const poolLeases: POOL.LeasesResponse.AsObject = {
    leases: [
        {
            channelPoint: stringToChannelPoint(
                lndListChannels.channels[5].channelPoint
            ),
        ...
        {
            channelPoint: stringToChannelPoint(
                lndListChannels.channels[6].channelPoint
            ),
            ...
            purchased: false,
            channelRemoteNodeKey:
                'A9L6+xEwFa2vULND3YYfdoCQwHqlzE5UyLvvQ+gfapg+',
            channelNodeTier: 1,
            selfChanBalance: 0,
            sidecarChannel: false,
            matchedOrderNonce: 'string'
        ...
        {
            channelPoint: stringToChannelPoint(
                lndListChannels.channels[7].channelPoint
            ),
            channelAmtSat: 1000000,
            channelDurationBlocks: 2016,
        ...
        {
            channelPoint: stringToChannelPoint(
                lndListChannels.channels[8].channelPoint
            ),
            channelAmtSat: 1000000,
            channelDurationBlocks: 2016,
            channelLeaseExpiry: 2317,
        ...
        {
            channelPoint: stringToChannelPoint(
                lndListChannels.channels[9].channelPoint
            ),
            channelAmtSat: 1000000,
            channelDurationBlocks: 2016,
...
export const poolRegisterSidecar: POOL.SidecarTicket.AsObject = {
    ticket: ''
};
